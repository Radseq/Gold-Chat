...
{
    class ClientJoinedChannelsListModule : ServerResponds, IClient, IBuildResponse
    {
        ...
        public ClientJoinedChannelsListModule(IClientLists ClientLists, ISeparateListOfStringToString SeparateList)
        {
